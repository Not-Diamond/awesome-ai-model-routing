...
- [LLM-PQR](https://github.com/Amazed-Labs/llm-pqr)*: Provider-neutral Python CLI for model selection using user-supplied quality, latency, cost, capability, and hard privacy constraints.
